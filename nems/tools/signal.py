...
class SignalBase:
    ...
    def __init__(self, fs, data, name, recording, chans=None, epochs=None,
                 ...
                 normalization='none', dtype=None, norm_baseline=np.array([[0]]),
...
class RasterizedSignal(SignalBase):
    ...
    def __init__(self, fs, data, name, recording, chans=None, epochs=None,
                 segments=None, meta=None, safety_checks=True,
                 normalization='none', sparse=False, dtype=None, **other_attributes):
        '''
        Parameters
        ----------
    ...
    def rasterize(self, fs=None, sparse=False, dtype=None):
        ...
        if sparse & ~self.sparse:
            return RasterizedSignal(fs=self.fs, data=self._data, name=self.name,
                             ...
                             epochs=self.epochs, meta=self.meta, sparse=sparse, dtype=dtype)
