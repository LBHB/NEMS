...
--------
    ...
    layers.py : Layer-specific visualizations, like `plot_strf`.
    model.py  : Whole-model plots, like `plot_model`.
    tools.py  : Helper functions for formatting matplotlib objects.

"""

from .model import plot_model, plot_layer, simple_strf, input_heatmap
from .layers import stp_input_output, plot_strf
from .fitter import (
